...
from dt_classificador import treinar_dt, prever_nivel_DT
...
def TalentRank_ArvoreDecisao():
    ...
    classificar_arvoreD, scaler = treinar_dt()
    nivel_usuario = prever_nivel_DT(classificar_arvoreD, scaler, respostas)
